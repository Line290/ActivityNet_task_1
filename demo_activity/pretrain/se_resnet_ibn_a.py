...
if __name__ == '__main__':
    # r'/data1/shentao/pretrained_model'
    basemodel = se_resnet101_ibn_a()
    state_dict = torch.load("/data1/shentao/pretrained_model/se_resnet101_ibn_a.pth.tar")["state_dict"]
    state_dict = state_dict_remove_moudle(state_dict, basemodel)
