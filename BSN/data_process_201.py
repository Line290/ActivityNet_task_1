...
arch, spatial_dir, temporal_dir, num_works, feat_dim = sys.argv[1:]
# arch = arch[0]
...
def readData(video_name,data_type=["spatial"]):
...
save_path = "./data/activitynet_feature_cuhk/"+arch+"_rescale_feats_RGB/"
